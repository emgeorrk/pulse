...
# The Vitals sets also have no gear, info, activity, update or exit glyphs; the
# Settings, About, Activity Monitor, Update and Quit items use SF Symbols.
...
for spec in "gearshape.fill settings" "info.circle about" "waveform.path.ecg activity" "arrow.down.circle.fill update" "rectangle.portrait.and.arrow.right quit"; do
  set -- $spec
